...
A neuron over a meter long sounds like something you ought to be able to spot with the naked eye — and in a sense, its *length* is in a visible range. Its *width* isn't. Axons are typically only [1 to 25 micrometers across](https://www.ncbi.nlm.nih.gov/books/NBK554388/), somewhere between a tenth and a fortieth the width of a human hair. A thread with essentially no width, to your eye, is nothing at all.
